...
export function weigh(app) {
    ...
    app.post("/api/v1/sweigh", restrict, decryptBody, validateRequest, withErrorHandling(startWeigh));
    app.post("/api/v1/eweigh", restrict, decryptBody, validateRequest, withErrorHandling(endWeigh));
